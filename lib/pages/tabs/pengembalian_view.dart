...
class _PengembalianViewState extends State<PengembalianView> {
  ...
  Future<void> _fetchPeminjaman() async {
    ...
    try {
      ...
      // Filter peminjaman yang statusnya HANYA 'approved'
                          ...
                          ? Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    'Hanya peminjaman yang sudah disetujui (APPROVED) dan dalam 7 hari setelah tanggal pinjam yang dapat dikembalikan',
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
